...
import tech.goksi.supportbot.events.*;
...
public class Bot {
    ...
    public void init(){
        ...
        jda.addEventListener(client, new ModalListener(), new OpenTicketListener(), new TicketListener(), new KeywordsListener(), new CommandListener());
